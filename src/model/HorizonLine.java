...
public class HorizonLine extends MyNode {
    private ImageView line;
    private String lineType;
    public HorizonLine(int x,int y) {
        super(0,x,y);
        this.lineType = "line_horizon";
        try{
            this.line = new ImageView(new Image("sources/img/draw_line_horizon.png"));
            this.line.setX(x);
            this.line.setY(y);
            this.line.setFitHeight(viewH);
            this.line.setFitWidth(viewW);
            this.line.setId("line_horizon");
        }catch(Exception e) {
            e.printStackTrace();
    ...
    @JSONCreator
    public HorizonLine(@JSONField(name="factoryID") int factoryID,
