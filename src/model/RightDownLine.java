...
public class RightDownLine extends MyNode {
    private ImageView line;
    private String lineType;
    public RightDownLine(int x,int y) {
        super(0,x,y);
        this.lineType = "line_right_down";
        try{
            this.line = new ImageView(new Image("sources/img/draw_line_right_down.png"));
            this.line.setX(x);
            this.line.setY(y);
            this.line.setFitHeight(viewH);
            this.line.setFitWidth(viewW);
            this.line.setId("line_right_down");
        }catch(Exception e) {
            e.printStackTrace();
    ...
    @JSONCreator
    public RightDownLine(@JSONField(name="factoryID") int factoryID,
