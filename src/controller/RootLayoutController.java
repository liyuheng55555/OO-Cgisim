...
public class RootLayoutController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // Run类初始化
        Run.setDrawController(drawController);
    ...
    public void run() {
        for(MyShape shapes : drawController.getShapeMap().values()){
            if(shapes instanceof StartNode){
                System.out.println("start node. "+"ID: "+shapes.getFactoryID()+ " nxt is: " + ((StartNode) shapes).getNxtID());
            }
            if(shapes instanceof EndNode){
                System.out.println("end node. "+"ID: "+shapes.getFactoryID()+ " pre is: " + ((EndNode) shapes).getPreID());
            }
            if(shapes instanceof IfNode){
                System.out.println("end node. "+"ID: "+shapes.getFactoryID()+ " pre is: " + ((IfNode) shapes).getPreID() + " trueID is " + ((IfNode) shapes).getTrueID() + " falseID is " + ((IfNode) shapes).getFalseID());
            }
        }
    }
    ...
    public void stepRun() {
        try{
            ...
            System.out.println("step run error");
        }
    }
