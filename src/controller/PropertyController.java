    ...
    public void setImage(String kind){
        switch (kind) {
            case "CurvedRectangle":
                workingImaging.setImage(new Image(new File("../resources/img/document.png").getAbsoluteFile().toURI().toString()));
                break;
            case "Decision":
                workingImaging.setImage(new Image(new File("../resources/img/decision.png").getAbsoluteFile().toURI().toString()));
                break;
            case "InputRectangle":
                workingImaging.setImage(new Image(new File("../resources/img/data.png").getAbsoluteFile().toURI().toString()));
                break;
            case "MyCircle":
                workingImaging.setImage(new Image(new File("../resources/img/prepare.png").getAbsoluteFile().toURI().toString()));
                break;
            case "RoundRectangle":
                workingImaging.setImage(new Image(new File("../resources/img/start.png").getAbsoluteFile().toURI().toString()));
                break;
            case "MyRectangle":
                workingImaging.setImage(new Image(new File("../resources/img/process.png").getAbsoluteFile().toURI().toString()));
                break;
            case "MyLine":
                workingImaging.setImage(new Image(new File("../resources/img/arrow.png").getAbsoluteFile().toURI().toString()));
                //workingImaging.setImage(new Image("file:////"+System.getProperty("user.dir")+"/image/arrow.png"));
                break;
            case "BrokenLine":
                workingImaging.setImage(new Image(new File("../resources/img/BrokenLine.png").getAbsoluteFile().toURI().toString()));
